      ...
      <div className="flex">
        ...
        <div className="mx-[50px] ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4  ">
            <div className="w-[270px] h-[270px] relative bg-stone-50 rounded-3xl shadow">
              <img
                className="w-[171px] h-[177px] left-[49px] top-[56px] absolute"
                src="https://via.placeholder.com/171x177"
              />
            ...
            <div className="w-[270px] h-[270px] pl-[49px] pr-[50px] pt-14 pb-[37px] bg-stone-50 rounded-3xl shadow justify-center items-center inline-flex">
              <img
                ...
                src="https://via.placeholder.com/177x177"
              />
            </div>
            <div className="w-[270px] h-[270px] pl-[49px] pr-[50px] pt-14 pb-[37px] bg-stone-50 rounded-3xl shadow justify-center items-center inline-flex">
              <img
